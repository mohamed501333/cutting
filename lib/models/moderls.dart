...
class CuttingOrderModel {
  ...
  @override
  String toString() {
    return 'CuttingOrderModel(id: $id, color: $color, type: $type, density: $density, customer: $customer, cutted: $cutted, recived: $recived, quality: $quality, out: $out, hight: $hight, wedth: $wedth, lenth: $lenth, amonunt: $amonunt, date: $date, datecutted: $datecutted, daterecieved: $daterecieved)';
  }
